...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void _onItemTapped(BuildContext context, int index) {
    ...
    switch (index) {
      case 1:
        ...
        break;
      case 2:
        Navigator.push(context, MaterialPageRoute(builder: (_) => const PaymentSummaryPage()));
        break;
      case 3:
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                _buildStatCard("In Progress", "${provider.inProgress}",
                                    Icons.work, Colors.orange),
                                _buildStatCard("Completed", "${provider.completed}",
                                    Icons.check_circle, Colors.green),
                                _buildStatCard("Payments", "Ksh ${provider.totalPayments}",
  ...
  // Keep your helper widgets the same (_buildStatCard, _buildTaskCard, _buildPaymentRow)…
